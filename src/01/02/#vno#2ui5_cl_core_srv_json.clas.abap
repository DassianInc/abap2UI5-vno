CLASS /vno/2ui5_cl_core_srv_json DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS model_front_to_back
      IMPORTING
        view    TYPE string
        t_attri TYPE REF TO /vno/2ui5_if_core_types=>ty_t_attri
...
CLASS /vno/2ui5_cl_core_srv_json IMPLEMENTATION.
    ...
    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
      ...
      TRY.
        ...
        CATCH cx_root INTO DATA(x).
          /vno/2ui5_cl_util=>x_raise( |JSON_PARSING_ERROR: { x->get_text( ) } | ).
      ENDTRY.
    ENDLOOP.
    ...
    TRY.
        ...
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.
          ...
          CASE lr_attri->bind_type.
            WHEN /vno/2ui5_if_core_types=>cs_bind_type-one_way
            OR /vno/2ui5_if_core_types=>cs_bind_type-two_way.
...
*              ASSERT sy-subrc = 0.
            ...
            WHEN /vno/2ui5_if_core_types=>cs_bind_type-one_time.
              ajson->set( iv_ignore_empty = abap_false
                          iv_path         = `/`
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result->set( iv_path = `/`
                           iv_val  = val-s_front ).
        ajson_result = ajson_result->filter( NEW /vno/2ui5_cl_core_srv_json( ) ).
