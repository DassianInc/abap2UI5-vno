CLASS /vno/2ui5_cl_core_handler DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE /vno/2ui5_if_core_types=>ty_s_request.
    DATA ms_response     TYPE /vno/2ui5_if_core_types=>ty_s_response.
...
CLASS /vno/2ui5_cl_core_handler IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    mv_request_json = val.
    mo_action = NEW /vno/2ui5_cl_core_action( me ).
  ...
  METHOD main_begin.
    TRY.
        ...
        ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
          NEW /vno/2ui5_cl_core_srv_draft( )->cleanup( ).
  ...
  METHOD main_end.
    ...
    IF CAST /vno/2ui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW /vno/2ui5_cl_core_client( mo_action ).
        DATA(li_app)    = CAST /vno/2ui5_if_app( mo_action->mo_app->mo_app ).
