INTERFACE /vno/2ui5_if_ajson_mapping
  PUBLIC.
  ...
  TYPES:
    ty_table_of TYPE STANDARD TABLE OF REF TO /vno/2ui5_if_ajson_mapping.
  ...
  METHODS rename_node
    IMPORTING
      !is_node TYPE /vno/2ui5_if_ajson_types=>ty_node
    CHANGING
      !cv_name TYPE /vno/2ui5_if_ajson_types=>ty_node-name.
