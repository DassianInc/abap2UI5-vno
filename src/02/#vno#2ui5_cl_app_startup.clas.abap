CLASS /vno/2ui5_cl_app_startup DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO /vno/2ui5_cl_app_startup.
  ...
  PROTECTED SECTION.
    DATA mt_classes TYPE /vno/2ui5_cl_util=>ty_t_classes.

  PRIVATE SECTION.
ENDCLASS.


CLASS /vno/2ui5_cl_app_startup IMPLEMENTATION.
  ...
  METHOD on_event_check.
    ...
    TRY.
        ...
        ms_home-url               = /vno/2ui5_cl_core_srv_util=>app_get_url( client    = client
  ...
  METHOD view_display_start.
    ...
    DATA(page) = /vno/2ui5_cl_xml_view=>factory( )->shell( )->page(
    ...
    DATA(lv_url_samples2) = /vno/2ui5_cl_core_srv_util=>app_get_url( client    = client
                                                                 classname = 'z2ui5_cl_demo_app_000' ).

    simple_form->toolbar( )->title( `What's next?` ).

    IF /vno/2ui5_cl_util=>rtti_check_class_exists( `z2ui5_cl_demo_app_000` ).
  ...
  METHOD view_display_popup.
    ...
    DATA(page2) = /vno/2ui5_cl_xml_view=>factory_popup(
    ...
    simple_form2->text( /vno/2ui5_if_app=>version ).
  ...
  METHOD z2ui5_on_event.
    ...
    DATA li_app TYPE REF TO /vno/2ui5_if_app.
...
*        client->nav_app_call( z2ui5_cl_core_app_info=>factory( ) ).
      ...
      WHEN 'VALUE_HELP'.
        TRY.
            mt_classes = /vno/2ui5_cl_util=>rtti_get_classes_impl_intf( /vno/2ui5_cl_util=>rtti_get_intfname_by_ref( li_app ) ).
          CATCH cx_root.
            client->message_box_display( `Unfortunately the value help is not available on your ABAP release!` ).
            RETURN.
        ENDTRY.
        client->nav_app_call( /vno/2ui5_cl_pop_to_select=>factory( mt_classes ) ).
    ENDCASE.
  ...
  METHOD z2ui5_on_init.
    ...
    ms_home-class_editable = abap_true.
    ms_home-btn_icon       = `sap-icon://validate`.
    ms_home-classname      = /vno/2ui5_cl_util=>rtti_get_classname_by_ref( NEW /vno/2ui5_cl_app_hello_world( ) ).
