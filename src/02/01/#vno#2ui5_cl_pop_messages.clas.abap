CLASS /vno/2ui5_cl_pop_messages DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO /vno/2ui5_cl_pop_messages.
...
CLASS /vno/2ui5_cl_pop_messages IMPLEMENTATION.
  METHOD factory.
...
*      lr_row->group = `001`.
  ...
  METHOD view_display.
    ...
    DATA(popup) = /vno/2ui5_cl_xml_view=>factory_popup( ).
