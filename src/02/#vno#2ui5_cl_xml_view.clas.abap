CLASS /vno/2ui5_cl_xml_view DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    CLASS-METHODS factory
      IMPORTING
        t_ns          TYPE /vno/2ui5_if_types=>ty_t_name_value OPTIONAL
      RETURNING
    ...
    METHODS _generic
      IMPORTING
        name          TYPE clike
        ns            TYPE clike                           OPTIONAL
        t_prop        TYPE /vno/2ui5_if_types=>ty_t_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO /vno/2ui5_cl_xml_view.

    METHODS _generic_property
      IMPORTING
        val           TYPE /vno/2ui5_if_types=>ty_s_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO /vno/2ui5_cl_xml_view.
    ...
    METHODS _z2ui5
      RETURNING
        VALUE(result) TYPE REF TO /vno/2ui5_cl_xml_view_cc.
  ...
  PROTECTED SECTION.
    ...
    DATA mt_prop     TYPE SORTED TABLE OF /vno/2ui5_if_types=>ty_s_name_value WITH NON-UNIQUE KEY n.

    DATA mt_ns       TYPE SORTED TABLE OF string WITH UNIQUE KEY table_line.
    DATA mo_root     TYPE REF TO /vno/2ui5_cl_xml_view.
    DATA mo_previous TYPE REF TO /vno/2ui5_cl_xml_view.
    DATA mo_parent   TYPE REF TO /vno/2ui5_cl_xml_view.
    DATA mt_child    TYPE STANDARD TABLE OF REF TO /vno/2ui5_cl_xml_view WITH EMPTY KEY.

  PRIVATE SECTION.
ENDCLASS.


CLASS /vno/2ui5_cl_xml_view IMPLEMENTATION.
  ...
  METHOD area_micro_chart.
    ...
    _generic( name   = `AreaMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `showLabel`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showlabel ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD avatar.
    ...
    _generic( name   = `Avatar`
              ...
              t_prop = VALUE #( ( n = `src`         v = src )
                                ...
                                ( n = `showBorder`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showborder ) )
                                ( n = `decorative`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `enabled`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
  ...
  METHOD base_rectangle.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `time`                      v = time )
                          ( n = `endTime`                   v = endtime )
                          ( n = `selectable`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( selectable ) )
                          ...
                          ( n = `connectable`               v = /vno/2ui5_cl_util=>boolean_abap_2_json( connectable ) )
                          ( n = `fontFamily`                v = fontfamily )
                          ( n = `filter`                    v = filter )
                          ( n = `transform`                 v = transform )
                          ( n = `countInBirdEye`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( countinbirdeye ) )
                          ( n = `fontWeight`                v = fontweight )
                          ( n = `showTitle`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtitle ) )
                          ( n = `selected`                  v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                          ( n = `resizable`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `horizontalTextAlignment`   v = horizontaltextalignment )
                          ( n = `shapeId`                   v = shapeid )
                          ( n = `highlighted`               v = /vno/2ui5_cl_util=>boolean_abap_2_json( highlighted ) )
                          ( n = `highlightable`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( highlightable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD bullet_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `actualValueLabel`  v = actualvaluelabel )
                          ...
                          ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `showActualValue`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showactualvalue ) )
                          ( n = `showActualValueInDeltaMode`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( savidm ) )
                          ( n = `showDeltaValue`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showdeltavalue ) )
                          ( n = `showTargetValue`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtargetvalue ) )
                          ( n = `showThresholds`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showthresholds ) )
                          ( n = `showValueMarker`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showvaluemarker ) )
                          ( n = `smallRangeAllowed`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( smallrangeallowed ) )
  ...
  METHOD busy_indicator.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `customIconDensityAware`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( customicondensityaware ) )
            ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD button.
    ...
    _generic( name   = `Button`
              ...
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `enabled` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `iconDensityAware` v = /vno/2ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst` v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `icon`    v = icon )
                                ( n = `type`    v = type )
                                ( n = `id`      v = id )
                                ( n = `width`   v = width )
  ...
  METHOD calendar_appointment.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `startDate`                 v = startdate )
                          ...
                          ( n = `key`                       v = key )
                          ( n = `selected`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                          ( n = `tentative`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( tentative ) )
                        ) ).
  ENDMETHOD.
  ...
  METHOD card_header.
    result = _generic( name   = `Header`
                       ...
                       t_prop = VALUE #( ( n = `id`  v = id )
                                         ...
                                         ( n = `iconVisible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconvisible ) )
                                         ( n = `visible`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD carousel.
    ...
    result = _generic( name   = `Carousel`
                       t_prop = VALUE #( ( n = `loop`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( loop ) )
                                         ( n = `class`  v = class )
                                         ( n = `height`  v = height )
                                         ( n = `id`  v = id )
  ...
  METHOD checkbox.
    ...
    _generic( name   = `CheckBox`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ...
                                ( n = `width` v = width )
                                ( n = `activeHandling`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( activehandling ) )
                                ( n = `enabled`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `displayOnly`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `editable`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( editable ) )
                                ( n = `partiallySelected`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( partiallyselected ) )
                                ( n = `useEntireWidth`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( useentirewidth ) )
                                ( n = `wrapping`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `select`   v = select )
                                ( n = `required`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `width` v = width )
                                   ...
                                   ( n = `id`         v = id )
                                   ( n = `class`         v = class )
                                   ( n = `mergeDuplicates` v = /vno/2ui5_cl_util=>boolean_abap_2_json( mergeduplicates ) )
                                   ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `demandPopin` v = /vno/2ui5_cl_util=>boolean_abap_2_json( demandpopin ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_list_item.
    result = _generic( name   = `ColumnListItem`
                       t_prop = VALUE #( ( n = `vAlign`   v = valign )
                                         ( n = `id` v = id )
                                         ( n = `selected` v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `unread` v = /vno/2ui5_cl_util=>boolean_abap_2_json( unread ) )
                                         ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `type`     v = type )
                                         ( n = `counter`     v = counter )
  ...
  METHOD column_menu_item.
    result = _generic( name   = `Item`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `confirm`    v = confirm )
                           ( n = `reset`    v = reset )
                           ( n = `resetButtonEnabled`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( resetbuttonenabled ) )
                           ( n = `showCancelButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcancelbutton ) )
                           ( n = `showConfirmButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showconfirmbutton ) )
                           ( n = `showResetButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showresetbutton ) )
                           ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_group_item.
    result = _generic( name   = `QuickGroupItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `label`    v = label )
                                         ( n = `grouped`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( grouped ) )
                                         ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_total_item.
    result = _generic( name   = `QuickTotalItem`
                       ...
                       t_prop = VALUE #( ( n = `id`       v = id )
                                         ...
                                         ( n = `key`    v = key )
                                         ( n = `label`    v = label )
                                         ( n = `totaled`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( totaled ) )
                                         ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `width`  v = width )
                          ...
                          ( n = `alignContent`      v = aligncontent )
                          ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `allowColumnLabels`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( allowcolumnlabels ) )
                          ( n = `showBottomLabels`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showbottomlabels ) )
                          ( n = `showTopLabels`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtoplabels ) )
                          ( n = `height`  v = height ) ) ).
  ENDMETHOD.
  ...
  METHOD combobox.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            (  n = `textAlign`         v = textalign )
            (  n = `showSecondaryValues`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsecondaryvalues ) )
            (  n = `visible`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
            (  n = `showValueStateMessage`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
            (  n = `showButton`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showbutton ) )
            (  n = `required`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) )
            (  n = `editable`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( editable ) )
            (  n = `enabled`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
            (  n = `filterSecondaryValues`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( filtersecondaryvalues ) )
            (  n = `width`         v = width )
  ...
  METHOD comparison_micro_chart.
    result = _generic( name   = `ComparisonMicroChart`
                      ...
                      t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                        ...
                                        ( n = `width`      v = width )
                                        ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                        ( n = `shrinkable`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( shrinkable ) )
                                        ( n = `view`  v = view ) ) ).
  ENDMETHOD.
  ...
  METHOD container_toolbar.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `alignCustomContentToRight` v = /vno/2ui5_cl_util=>boolean_abap_2_json( aligncustomcontenttoright ) )
            ( n = `findMode`                  v = findmode )
            ( n = `infoOfSelectItems`         v = infoofselectitems )
            ( n = `findbuttonpress`           v = findbuttonpress )
            ( n = `showBirdEyeButton`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showbirdeyebutton ) )
            ( n = `showDisplayTypeButton`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showdisplaytypebutton ) )
            ( n = `showLegendButton`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( showlegendbutton ) )
            ( n = `showSettingButton`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsettingbutton ) )
            ( n = `showTimeZoomControl`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtimezoomcontrol ) )
  ...
  METHOD core_custom_data.
    ...
    _generic( name   = `CustomData`
              ...
              t_prop = VALUE #( ( n = `value` v = value )
                                ( n = `key` v = key )
                                ( n = `writeToDom` v = /vno/2ui5_cl_util=>boolean_abap_2_json( writetodom ) ) ) ).
  ...
  METHOD currency.
    result = _generic( name   = `Currency`
                       ...
                       t_prop = VALUE #( ( n = `value`        v = value )
                                         ...
                                         ( n = `useSymbol`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( usesymbol ) )
  ...
  METHOD date_picker.
    ...
    _generic( name   = `DatePicker`
              t_prop = VALUE #(
                  ...
                  ( n = `visible`               v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                  ( n = `editable`              v = /vno/2ui5_cl_util=>boolean_abap_2_json( editable ) )
                  ( n = `hideInput`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideinput ) )
                  ( n = `showFooter`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( showfooter ) )
                  ( n = `showValueStateMessage` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                  ( n = `showCurrentDateButton` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcurrentdatebutton ) ) ) ).
  ENDMETHOD.
  ...
  METHOD dialog.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `title`  v = title )
                          ...
                          ( n = `closeOnNavigation`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( closeonnavigation ) )
                          ( n = `draggable`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( draggable ) )
                          ( n = `resizable`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `horizontalScrolling`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( horizontalscrolling ) )
                          ( n = `verticalScrolling`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( verticalscrolling ) )
                          ( n = `afterOpen`  v = afteropen )
                          ( n = `beforeClose`  v = beforeclose )
                          ( n = `beforeOpen`  v = beforeopen )
                          ( n = `afterClose` v = afterclose ) ) ).
  ...
  METHOD dynamic_page.
    result = _generic( name   = `DynamicPage`
                       ns     = `f`
                       t_prop = VALUE #(
                           (  n = `headerExpanded`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( headerexpanded ) )
                           (  n = `headerPinned`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( headerpinned ) )
                           (  n = `showFooter`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showfooter ) )
  ...
  METHOD dynamic_page_header.
    result = _generic(
                 ...
                 ns     = `f`
                 t_prop = VALUE #( (  n = `pinnable`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( pinnable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD expandable_text.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `renderWhitespace`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( renderwhitespace ) )
                     ( n = `text`        v = text )
                     ( n = `textAlign`         v = textalign )
                     ( n = `textDirection`       v = textdirection )
  ...
  METHOD facet_filter.
    result = _generic( name   = `FacetFilter`
                       t_prop = VALUE #(
                           ( n = `id`  v = id )
                           ( n = `class`  v = class )
                           ( n = `liveSearch`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( livesearch ) )
                           ( n = `showPersonalization` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showpersonalization ) )
                           ( n = `showPopoverOKButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showpopoverokbutton ) )
                           ( n = `showReset`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( showreset ) )
                           ( n = `showSummaryBar`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsummarybar ) )
                           ( n = `type`         v = type )
                           ( n = `confirm`        v = confirm )
                           ( n = `reset` v = reset )
                           ( n = `lists` v = lists )
  ...
  METHOD facet_filter_list.
    result = _generic(
        ...
        t_prop = VALUE #(
            ( n = `id`  v = id )
            ( n = `class`  v = class )
            ( n = `active`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( active ) )
            ...
            ( n = `enableCaseInsensitiveSearch` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecaseinsensitivesearch ) )
            ...
            ( n = `mode` v = mode )
            ( n = `modeAnimationOn` v = /vno/2ui5_cl_util=>boolean_abap_2_json( modeanimationon ) )
            ...
            ( n = `retainListSequence` v = /vno/2ui5_cl_util=>boolean_abap_2_json( retainlistsequence ) )
            ( n = `sequence` v = sequence )
            ( n = `showNoData` v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownodata ) )
            ( n = `showRemoveFacetIcon` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showremovefaceticon ) )
            ( n = `showSeparators` v = showseparators )
            ( n = `showUnread` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showunread ) )
            ( n = `sticky` v = sticky )
            ( n = `title` v = title )
            ( n = `width` v = width )
            ( n = `wordWrap` v = /vno/2ui5_cl_util=>boolean_abap_2_json( wordwrap ) )
  ...
  METHOD feed_input.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `buttonTooltip`    v = buttontooltip )
                                   ...
                                   ( n = `placeholder`      v = placeholder )
                                   ( n = `rows`             v = rows )
                                   ( n = `showExceededText` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showexceededtext ) )
                                   ( n = `showIcon`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showicon ) )
                                   ( n = `value`            v = value )
                                   ( n = `class`            v = class )
                                   ( n = `post`             v = post ) ) ).
  ...
  METHOD feed_list_item.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `iconActive`                  v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconactive ) )
                     ( n = `icon`                        v = icon )
                     ( n = `iconDensityAware`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                     ( n = `iconDisplayShape`            v = icondisplayshape )
                     ( n = `iconInitials`                v = iconinitials )
                     ...
                     ( n = `sender`                      v = sender )
                     ( n = `senderActive`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( senderactive ) )
                     ( n = `showIcon`                    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showicon ) )
                     ( n = `text`                        v = text )
  ...
  METHOD feed_list_item_action.
    result = _generic( name   = `FeedListItemAction`
                       t_prop = VALUE #( ( n = `enabled` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `icon`    v = icon )
                                         ( n = `key`     v = key )
                                         ( n = `text`    v = text )
                                         ( n = `press`   v = press )
  ...
  METHOD filter_bar.
    ...
    result = _generic(
        ...
        ns     = 'fb'
        t_prop = VALUE #(
            ( n = 'useToolbar'     v = /vno/2ui5_cl_util=>boolean_abap_2_json( usetoolbar ) )
            ( n = 'search'         v = search )
            ( n = 'id'             v = id )
            ...
            ( n = 'header' v = header )
            ( n = 'advancedMode' v = /vno/2ui5_cl_util=>boolean_abap_2_json( advancedmode ) )
            ( n = 'isRunningInValueHelpDialog' v = /vno/2ui5_cl_util=>boolean_abap_2_json( isrunninginvaluehelpdialog ) )
            ( n = 'showAllFilters' v = /vno/2ui5_cl_util=>boolean_abap_2_json( showallfilters ) )
            ( n = 'showClearOnFB' v = /vno/2ui5_cl_util=>boolean_abap_2_json( showclearonfb ) )
            ( n = 'showFilterConfiguration' v = /vno/2ui5_cl_util=>boolean_abap_2_json( showfilterconfiguration ) )
            ( n = 'showGoOnFB' v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgoonfb ) )
            ( n = 'showRestoreButton' v = /vno/2ui5_cl_util=>boolean_abap_2_json( showrestorebutton ) )
            ( n = 'showRestoreOnFB' v = /vno/2ui5_cl_util=>boolean_abap_2_json( showrestoreonfb ) )
            ( n = 'useSnapshot' v = /vno/2ui5_cl_util=>boolean_abap_2_json( usesnapshot ) )
            ( n = 'searchEnabled' v = /vno/2ui5_cl_util=>boolean_abap_2_json( searchenabled ) )
            ( n = 'considerGroupTitle' v = /vno/2ui5_cl_util=>boolean_abap_2_json( considergrouptitle ) )
            ( n = 'deltaVariantMode' v = /vno/2ui5_cl_util=>boolean_abap_2_json( deltavariantmode ) )
            ( n = 'disableSearchMatchesPatternWarning'
              v = /vno/2ui5_cl_util=>boolean_abap_2_json( disablesearchmatchespatternw ) )
            ( n = 'filterBarExpanded' v = /vno/2ui5_cl_util=>boolean_abap_2_json( filterbarexpanded ) )
  ...
  METHOD filter_group_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = 'name'                v  = name )
                          ...
                          ( n = 'change'           v  = change )
                          ( n = 'visibleInFilterBar'  v  = /vno/2ui5_cl_util=>boolean_abap_2_json( visibleinfilterbar ) )
                          ( n = 'mandatory'  v  = /vno/2ui5_cl_util=>boolean_abap_2_json( mandatory ) )
                          ( n = 'hiddenFilter'  v  = /vno/2ui5_cl_util=>boolean_abap_2_json( hiddenfilter ) )
                          ( n = 'visible'  v  = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                        ) ).
  ...
  METHOD flexible_column_layout.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            (  n = `autoFocus` v = /vno/2ui5_cl_util=>boolean_abap_2_json( autofocus ) )
            (  n = `restoreFocusOnBackNavigation` v = /vno/2ui5_cl_util=>boolean_abap_2_json( restorefocusonbacknavigation ) ) ) ).
  ...
  METHOD flex_box.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `class`  v = class )
                                   ...
                                   ( n = `fitContainer`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( fitcontainer ) )
                                   ...
                                   ( n = `alignContent`  v = aligncontent )
                                   ( n = `backgroundDesign`  v = backgrounddesign )
                                   ( n = `displayInline`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( displayinline ) )
                                   ( n = `visible`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD gantt_chart_with_table.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `isConnectorDetailsVisible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( isconnectordetailsvisible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD generic_tile.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ( n = `renderOnThemeChange`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( renderonthemechange ) )
                     ( n = `enableNavigationButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablenavigationbutton ) )
                     ( n = `pressEnabled`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( pressenabled ) )
                     ( n = `iconLoaded`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconloaded ) )
  ...
  METHOD grid.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `defaultSpan`    v = default_span )
                                   ( n = `class`          v = class )
                                   ( n = `containerQuery` v = /vno/2ui5_cl_util=>boolean_abap_2_json( containerquery ) )
  ...
  METHOD grid_data.
    ...
    _generic( name   = `GridData`
              ...
              t_prop = VALUE #( ( n = `span`      v = span )
                                ( n = `linebreak` v = /vno/2ui5_cl_util=>boolean_abap_2_json( linebreak ) )
                                ( n = `indentL`   v = indentl )
                                ( n = `indentM`   v = indentm ) ) ).
  ENDMETHOD.
  ...
  METHOD group.
    result = _generic( name   = `group`
                       ns     = `networkgraph`
                       t_prop = VALUE #( ( n = `collapsed`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( collapsed ) )
                                         ( n = `id`       v = id )
                                         ( n = `class`       v = class )
  ...
  METHOD harvey_ball_micro_chart.
    ...
    result = _generic( name   = `HarveyBallMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `alignContent`      v = aligncontent )
                                ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `formattedLabel`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( formattedlabel ) )
                                ( n = `showFractions`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showfractions ) )
                                ( n = `showTotal`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtotal ) )
  ...
  METHOD header_container_control.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `backgroundDesign` v = backgrounddesign )
                                   ( n = `gridLayout` v = /vno/2ui5_cl_util=>boolean_abap_2_json( gridlayout ) )
                                   ( n = `height` v = height )
                                   ( n = `orientation` v = orientation )
                                   ( n = `scrollStep` v = scrollstep )
                                   ( n = `scrollStepByItem` v = scrollstepbyitem )
                                   ( n = `scrollTime` v = scrolltime )
                                   ( n = `showDividers` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showdividers ) )
                                   ( n = `showOverflowItem` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showoverflowitem ) )
                                   ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `snapToRow ` v = /vno/2ui5_cl_util=>boolean_abap_2_json( snaptorow ) )
                                   ( n = `width` v = width )
                                   ( n = `id` v = id )
                                   ( n = `scroll` v = scroll ) ) ).
  ENDMETHOD.
  ...
  METHOD horizontal_layout.
    result = _generic(
                 ...
                 ns     = `layout`
                 t_prop = VALUE #( ( n = `class`  v = class )
                                   ( n = `allowWrapping`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( allowwrapping ) )
                                   ( n = `id`  v = id )
                                   ( n = `visible`  v = visible ) ) ).
  ENDMETHOD.
  ...
  METHOD html.
    ...
    result = _generic( name   = `HTML`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = 'preferDOM' v = /vno/2ui5_cl_util=>boolean_abap_2_json( preferdom ) )
                           ( n = 'sanitizeContent' v = /vno/2ui5_cl_util=>boolean_abap_2_json( sanitizecontent ) )
                           ( n = 'visible' v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD icon.
    ...
    _generic( name   = `Icon`
              ...
              t_prop = VALUE #( ( n = `size`  v = size )
                                ...
                                ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `decorative`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `noTabStop`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( notabstop ) )
                                ( n = `useIconTooltip`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( useicontooltip ) ) ) ).
  ...
  METHOD icon_tab_bar.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `select`      v = select )
                     ( n = `expand`      v = expand )
                     ( n = `expandable`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( expandable ) )
                     ( n = `expanded`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( expanded ) )
                     ( n = `applyContentPadding`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( applycontentpadding ) )
                     ( n = `backgroundDesign`    v = backgrounddesign )
                     ( n = `enableTabReordering`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabletabreordering ) )
                     ( n = `headerBackgroundDesign`    v = headerbackgrounddesign )
                     ( n = `stretchContentHeight`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( stretchcontentheight ) )
                     ...
                     ( n = `id`    v = id )
                     ( n = `content`    v = content )
                     ( n = `upperCase`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( uppercase ) )
                     ( n = `selectedKey` v = selectedkey ) ) ).
  ENDMETHOD.
  ...
  METHOD icon_tab_filter.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `icon`        v = icon )
                          ...
                          ( n = `showAll`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showall ) )
                          ( n = `iconDensityAware`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                          ( n = `visible`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `count`       v = count )
                          ( n = `text`        v = text )
  ...
  METHOD illustrated_message.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enableFormattedText`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableformattedtext ) )
  ...
  METHOD image.
    ...
    _generic( name   = `Image`
              t_prop = VALUE #( ( n = `id` v = id )
                                ...
                                ( n = `load` v = load )
                                ( n = `decorative` v = /vno/2ui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `densityAware` v = /vno/2ui5_cl_util=>boolean_abap_2_json( densityaware ) )
                                ( n = `lazyLoading` v = /vno/2ui5_cl_util=>boolean_abap_2_json( lazyloading ) ) ) ).
  ENDMETHOD.
  ...
  METHOD input.
    ...
    _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enabled`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
            ( n = `visible`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
            ( n = `enableTableAutoPopinMode` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabletableautopopinmode ) )
            ( n = `enableSuggestionsHighlighting`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablesuggestionshighlighting ) )
            ( n = `showTableSuggestionValueHelp`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtablesuggestionvaluehelp ) )
            ( n = `valueState`       v = valuestate )
            ( n = `valueStateText`   v = valuestatetext )
            ( n = `value`            v = value )
            ( n = `required`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) )
            ...
            ( n = `showSuggestion`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsuggestion ) )
            ( n = `valueHelpRequest` v = valuehelprequest )
            ( n = `autocomplete`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( autocomplete ) )
            ( n = `valueLiveUpdate`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( valueliveupdate ) )
            ( n = `submit`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( submit ) )
  ...
  METHOD interact_bar_chart.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `selectionChanged`  v = selectionchanged )
                          ( n = `selectionEnabled`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( selectionenabled ) )
                          ( n = `showError`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showerror ) )
                          ( n = `press`             v = press )
  ...
  METHOD label.
    ...
    _generic( name   = `Label`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ( n = `displayOnly`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `required`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) )
                                ( n = `showColon`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcolon ) )
                                ( n = `textAlign`   v = textalign )
                                ( n = `textDirection`   v = textdirection )
                                ( n = `vAlign`   v = valign )
                                ( n = `width`   v = width )
  ...
  METHOD layered_layout.
    result = _generic( name   = `LayeredLayout`
                       ...
                       t_prop = VALUE #( ( n = `id`  v = id )
                                         ...
                                         ( n = `mergeEdges`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( mergeedges ) ) ) ).
  ENDMETHOD.
  ...
  METHOD library_shape.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`       v = id )
                          ( n = `class`    v = class )
                          ( n = `animationOnChange`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( animationonchange ) )
  ...
  METHOD line.
    ...
    result = _generic( name   = `Line`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `hover`        v = hover )
                           ( n = `press`        v = press )
                           ( n = `stretchToCenter`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( stretchtocenter ) )
                           ( n = `selected`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                           ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD line_micro_chart.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `color`  v = color )
                          ...
                          ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                          ( n = `showBottomLabels`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showbottomlabels ) )
                          ( n = `showPoints`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showpoints ) )
                          ( n = `showThresholdLine`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showthresholdline ) )
                          ( n = `showThresholdValue`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showthresholdvalue ) )
                          ( n = `showTopLabels`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtoplabels ) )
                          ( n = `maxYValue`  v = maxyvalue ) ) ).
  ENDMETHOD.
  ...
  METHOD line_micro_chart_empszd_point.
    result = _generic( name   = `LineMicroChartEmphasizedPoint`
                       ...
                       t_prop = VALUE #( ( n = `x`       v = x )
                                         ( n = `y`       v = y )
                                         ( n = `color`       v = color )
                                         ( n = `show`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( show ) )
                                       ) ).
  ENDMETHOD.
  ...
  METHOD link.
    ...
    _generic( name   = `Link`
              ...
              t_prop = VALUE #( ( n = `text`    v = text )
                                ...
                                ( n = `emptyIndicatorMode`      v = emptyindicatormode )
                                ( n = `rel`      v = rel )
                                ( n = `subtle`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( subtle ) )
                                ( n = `textAlign`      v = textalign )
                                ( n = `textDirection`      v = textdirection )
                                ( n = `validateUrl`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( validateurl ) )
                                ( n = `width`      v = width )
                                ( n = `wrapping`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `emphasized`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `enabled` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `endIcon` v = endicon )
                                ( n = `icon`    v = icon ) ) ).
  ENDMETHOD.
  ...
  METHOD message_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `type`                v = type )
                          ...
                          ( n = `textDirection`       v = textdirection )
                          ( n = `groupName`           v = groupname )
                          ( n = `activeTitle`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( activetitle ) )
                          ( n = `counter`             v = counter )
                          ( n = `markupDescription`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( markupdescription ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_page.
    result = _generic(
                 name   = `MessagePage`
                 t_prop = VALUE #(
                     ( n = `showHeader`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( show_header ) )
                     ( n = `description`         v = description )
                     ( n = `icon`                v = icon )
                     ( n = `text`                v = text )
                     ( n = `enableFormattedText` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableformattedtext ) ) ) ).
  ...
  METHOD message_popover.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `items`             v = items )
                          ...
                          ( n = `afterClose`        v = afterclose )
                          ( n = `beforeClose`       v = beforeclose )
                          ( n = `initiallyExpanded` v = /vno/2ui5_cl_util=>boolean_abap_2_json( initiallyexpanded ) )
                          ( n = `groupItems`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( groupitems ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_strip.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `text`     v = text )
                          ...
                          ( n = `customIcon`       v = customicon )
                          ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `showCloseButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
                          ( n = `class`    v = class )
                          ( n = `enableFormattedText`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableformattedtext ) ) ) ).
  ENDMETHOD.
  ...
  METHOD micro_process_flow_item.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`       v = id )
                          ...
                          ( n = `key`    v = key )
                          ( n = `icon`    v = icon )
                          ( n = `showSeparator`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showseparator ) )
                          ( n = `showIntermediary`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showintermediary ) )
                       ) ).
  ENDMETHOD.
  ...
  METHOD network_graph.
    result = _generic( name   = `Graph`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `enableWheelZoom`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablewheelzoom ) )
                           ( n = `enableZoom`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablezoom ) )
                           ( n = `noData`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( nodata ) )
                           ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD node.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `hover` v = hover )
            ( n = `press` v = press )
            ( n = `collapsed`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( collapsed ) )
            ( n = `selected`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
            ( n = `showActionLinksButton`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showactionlinksbutton ) )
            ( n = `showDetailButton`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showdetailbutton ) )
            ( n = `showExpandButton`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showexpandbutton ) )
            ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD notification_list_group.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ( n = `autoPriority`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( autopriority ) )
                     ( n = `collapsed`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( collapsed ) )
                     ( n = `enableCollapseButtonWhenEmpty`
                       v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecollapsebuttonwhenempty ) )
                     ( n = `navigated`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                     ( n = `showButtons`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showbuttons ) )
                     ( n = `showCloseButton`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
                     ( n = `showEmptyGroup`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showemptygroup ) )
                     ( n = `showItemsCounter`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showitemscounter ) )
                     ( n = `unread`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( unread ) ) ) ).
  ENDMETHOD.
  ...
  METHOD notification_list_item.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `press`  v = press )
                     ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ( n = `hideShowMoreButton`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideshowmorebutton ) )
                     ( n = `truncate`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( truncate ) )
                     ( n = `highlight`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( highlight ) )
                     ( n = `navigated`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                     ( n = `showButtons`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showbuttons ) )
                     ( n = `showCloseButton`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
  ...
  METHOD numeric_content.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `value`      v = value )
                          ...
                          ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `nullifyValue` v = /vno/2ui5_cl_util=>boolean_abap_2_json( nullifyvalue ) )
                          ( n = `formatterValue` v = /vno/2ui5_cl_util=>boolean_abap_2_json( formattervalue ) )
                          ( n = `animateTextChange` v = /vno/2ui5_cl_util=>boolean_abap_2_json( animatetextchange ) )
                          ( n = `adaptiveFontSize` v = /vno/2ui5_cl_util=>boolean_abap_2_json( adaptivefontsize ) )
                          ( n = `withMargin` v = /vno/2ui5_cl_util=>boolean_abap_2_json( withmargin ) )
                          ( n = `class`      v = class )
                          ( n = `press`      v = press ) ) ).
  ...
  METHOD numeric_header.
    ...
    result = _generic( name   = `NumericHeader`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `statusVisible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( statusvisible ) )
                           ( n = `numberVisible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( numbervisible ) )
                           ( n = `iconVisible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconvisible ) )
                           ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ENDMETHOD.
  ...
  METHOD object_header.
    ...
    result = _generic(
        name   = `ObjectHeader`
        t_prop = VALUE #( ( n = `backgrounddesign`     v = backgrounddesign )
                          ( n = `condensed`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( condensed ) )
                          ( n = `fullscreenoptimized`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( fullscreenoptimized ) )
                          ( n = `icon`                 v = icon )
                          ( n = `iconactive`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconactive ) )
                          ( n = `iconalt`              v = iconalt )
                          ( n = `icondensityaware`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                          ...
                          ( n = `intro`                v = intro )
                          ( n = `introactive`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( introactive ) )
                          ...
                          ( n = `responsive`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( responsive ) )
                          ( n = `showtitleselector`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtitleselector ) )
                          ( n = `title`                v = title )
                          ( n = `titleactive`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( titleactive ) )
  ...
  METHOD object_number.
    ...
    _generic( name   = `ObjectNumber`
              t_prop = VALUE #( ( n = `emphasized`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `number`             v = number )
                                ( n = `state`              v = state )
                                ( n = `id`          v = id )
                                ( n = `class`          v = class )
                                ...
                                ( n = `numberunit`         v = numberunit )
                                ( n = `active`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( active ) )
                                ( n = `inverted`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( inverted ) )
                                ( n = `visible`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `unit`               v = unit ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_header.
    ...
    _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `isActionAreaAlwaysVisible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( isactionareaalwaysvisible ) )
            ( n = `isObjectIconAlwaysVisible`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( isobjecticonalwaysvisible ) )
            ( n = `isObjectSubtitleAlwaysVisible`
              v = /vno/2ui5_cl_util=>boolean_abap_2_json( isobjectsubtitlealwaysvisible ) )
            ( n = `isObjectTitleAlwaysVisible`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( isobjecttitlealwaysvisible ) )
            ( n = `markChanges`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( markchanges ) )
            ( n = `markFavorite`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( markfavorite ) )
            ( n = `markFlagged`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( markflagged ) )
            ( n = `markLocked`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( marklocked ) )
            ( n = `objectImageDensityAware`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( objectimagedensityaware ) )
            ( n = `showMarkers`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showmarkers ) )
            ( n = `showPlaceholder`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showplaceholder ) )
            ( n = `showTitleSelector`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtitleselector ) )
            ( n = `visible`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD object_page_header_action_btn.
    ...
    _generic( name   = `ObjectPageHeaderActionButton`
              ...
              t_prop = VALUE #( ( n = `activeIcon`  v = activeicon )
                                ...
                                ( n = `width`      v = width )
                                ( n = `enabled`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `hideIcon`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideicon ) )
                                ( n = `hideText`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hidetext ) )
                                ( n = `iconDensityAware`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `visible`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `press`  v = press ) ) ).
  ...
  METHOD object_page_layout.
    result = _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `showTitleInHeaderContent` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtitleinheadercontent ) )
            ( n = `showEditHeaderButton`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showeditheaderbutton ) )
            ( n = `alwaysShowContentHeader`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( alwaysshowcontentheader ) )
            ( n = `enableLazyLoading`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablelazyloading ) )
            ( n = `flexEnabled`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( flexenabled ) )
            ( n = `headerContentPinnable`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( headercontentpinnable ) )
            ( n = `headerContentPinned`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( headercontentpinned ) )
            ( n = `isChildPage`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( ischildpage ) )
            ( n = `preserveHeaderStateOnScroll`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( preserveheaderstateonscroll ) )
            ( n = `showAnchorBar`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showanchorbar ) )
            ( n = `showAnchorBarPopover`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showanchorbarpopover ) )
            ( n = `showHeaderContent`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showheadercontent ) )
            ( n = `showOnlyHighImportance`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showonlyhighimportance ) )
            ( n = `subSectionLayout`     v = subsectionlayout )
            ( n = `toggleHeaderOnTitleClick`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( toggleheaderontitleclick ) )
            ( n = `useIconTabBar`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( useicontabbar ) )
            ( n = `useTwoColumnsForLargeScreen`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( usetwocolumnsforlargescreen ) )
            ( n = `visible`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
            ...
            ( n = `upperCaseAnchorBar`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( uppercaseanchorbar ) )
  ...
  METHOD object_page_section.
    result = _generic(
                 ...
                 ns     = `uxap`
                 t_prop = VALUE #( ( n = `titleUppercase`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( titleuppercase ) )
                                   ( n = `title`           v = title )
                                   ( n = `id`              v = id )
                                   ( n = `anchorBarButtonColor`              v = anchorbarbuttoncolor )
                                   ( n = `titleLevel`      v = titlelevel )
                                   ( n = `titleVisible`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( titlevisible ) )
                                   ( n = `showTitle`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                   ( n = `visible`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `wrapTitle`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( wraptitle ) )
                                   ( n = `importance`      v = importance ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_sub_section.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`    v = id )
                                   ...
                                   ( n = `titleVisible`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( titlevisible ) )
                                   ( n = `showTitle`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                   ( n = `titleUppercase`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( titleuppercase ) )
                                   ( n = `visible`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `title` v = title ) ) ).
  ENDMETHOD.
  ...
  METHOD overflow_toolbar.
    result = _generic( name   = `OverflowToolbar`
                       t_prop = VALUE #( ( n = `press`   v = press )
                                         ...
                                         ( n = `active` v = /vno/2ui5_cl_util=>boolean_abap_2_json( active ) )
                                         ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `asyncMode` v = /vno/2ui5_cl_util=>boolean_abap_2_json( asyncmode ) )
                                         ( n = `enabled` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `design`    v = design )
                                         ( n = `type`    v = type )
                                         ( n = `style`    v = style )
  ...
  METHOD page.
    result = _generic(
                 ...
                 ns     = ns
                 t_prop = VALUE #( ( n = `title` v = title )
                                   ( n = `showNavButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownavbutton ) )
                                   ( n = `navButtonPress` v = navbuttonpress )
                                   ( n = `showHeader` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showheader ) )
                                   ( n = `class` v = class )
                                   ( n = `backgroundDesign` v = backgrounddesign )
                                   ( n = `navButtonTooltip` v = navbuttontooltip )
                                   ( n = `titleAlignment` v = titlealignment )
                                   ( n = `titleLevel` v = titlelevel )
                                   ( n = `contentOnlyBusy` v = /vno/2ui5_cl_util=>boolean_abap_2_json( contentonlybusy ) )
                                   ( n = `enableScrolling` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablescrolling ) )
                                   ( n = `floatingFooter` v = /vno/2ui5_cl_util=>boolean_abap_2_json( floatingfooter ) )
                                   ( n = `showFooter` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showfooter ) )
                                   ( n = `showSubHeader` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsubheader ) )
                                   ( n = `id` v = id ) ) ).
  ENDMETHOD.
  ...
  METHOD panel.
    ...
    result = _generic(
                 name   = `Panel`
                 t_prop = VALUE #( ( n = `expandable` v = /vno/2ui5_cl_util=>boolean_abap_2_json( expandable ) )
                                   ( n = `expanded`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( expanded ) )
                                   ( n = `stickyHeader`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( stickyheader ) )
                                   ( n = `expandAnimation`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( expandanimation ) )
                                   ( n = `visible`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `height`   v = height )
                                   ( n = `backgroundDesign`   v = backgrounddesign )
                                   ( n = `width`   v = width )
  ...
  METHOD planning_calendar.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `viewKey`         v = viewkey )
            ( n = `width`         v = width )
            ( n = `singleSelection`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( singleselection ) )
            ( n = `showRowHeaders`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showrowheaders ) )
            ( n = `multipleAppointmentsSelection`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( multipleappointmentsselection ) )
            ( n = `showIntervalHeaders`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showintervalheaders ) )
            ( n = `showEmptyIntervalHeaders`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showemptyintervalheaders ) )
            ( n = `showWeekNumbers`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showweeknumbers ) )
            ( n = `legend`                    v = legend )
            ( n = `showDayNamesLine`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( showdaynamesline ) ) ) ).
  ENDMETHOD.
  ...
  METHOD planning_calendar_row.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `enableAppointmentsCreate`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableappointmentscreate ) )
            ...
            ( n = `selected`                        v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
            ( n = `nonWorkingDays`                  v = nonworkingdays )
            ( n = `enableAppointmentsResize`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableappointmentsresize ) )
            ( n = `enableAppointmentsDragAndDrop`
              v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableappointmentsdraganddrop ) )
            ( n = `text`                            v = text )
                        ) ).
  ...
  METHOD planning_calendar_view.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `appointmentHeight`                      v = appointmentheight )
                          ...
                          ( n = `key`  v = key )
                          ( n = `relative`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( relative ) )
                          ( n = `showSubIntervals`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsubintervals ) )
                        ) ).
  ENDMETHOD.
  ...
  METHOD popover.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`         v = id )
                          ...
                          ( n = `contentHeight` v = contentheight )
                          ( n = `showHeader`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showheader ) )
                          ( n = `showArrow`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showarrow ) )
                          ( n = `resizable`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( resizable ) )
                          ( n = `modal`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( modal ) )
                          ( n = `horizontalScrolling`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( horizontalscrolling ) )
                          ( n = `verticalScrolling`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( verticalscrolling ) )
                          ( n = `visible`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                          ( n = `offsetX`    v = offsetx )
  ...
  METHOD process_flow.
    result = _generic(
                 ...
                 ns     = 'commons'
                 t_prop = VALUE #( ( n = `id`               v = id )
                                   ( n = `foldedCorners`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( foldedcorners ) )
                                   ( n = `scrollable`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( scrollable ) )
                                   ( n = `showLabels`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showlabels ) )
                                   ( n = `visible`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                   ( n = `wheelZoomable`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( wheelzoomable ) )
  ...
  METHOD process_flow_node.
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `laneId`               v = laneid )
                                   ...
                                   ( n = `texts`                v = texts )
                                   ( n = `highlighted`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( highlighted ) )
                                   ( n = `focused`              v = /vno/2ui5_cl_util=>boolean_abap_2_json( focused ) )
                                   ( n = `selected`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                                   ( n = `tag`                  v = tag )
                                   ( n = `texts`                v = texts )
                                   ( n = `type`                 v = type ) ) ).
  ...
  METHOD progress_indicator.
    ...
    _generic( name   = `ProgressIndicator`
              t_prop = VALUE #( ( n = `class`        v = class )
                                ...
                                ( n = `displayValue` v = displayvalue )
                                ( n = `showValue`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showvalue ) )
                                ( n = `visible`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `state`        v = state ) ) ).
  ENDMETHOD.
...
*              ns     = `webc`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `showTickmarks`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtickmarks ) )
  ...
  METHOD rich_text_editor.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `buttonGroups`        v = buttongroups )
                          ( n = `customToolbar`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( customtoolbar ) )
                          ( n = `editable`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( editable ) )
                          ( n = `height`              v = height )
                          ...
                          ( n = `required`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) )
                          ( n = `sanitizeValue`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( sanitizevalue ) )
                          ( n = `showGroupClipboard`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgroupclipboard ) )
                          ( n = `showGroupFont`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgroupfont ) )
                          ( n = `showGroupFontStyle`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgroupfontstyle ) )
                          ( n = `showGroupInsert`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgroupinsert ) )
                          ( n = `showGroupLink`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgrouplink ) )
                          ( n = `showGroupStructure`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgroupstructure ) )
                          ( n = `showGroupTextAlign`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgrouptextalign ) )
                          ( n = `showGroupUndo`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showgroupundo ) )
                          ( n = `useLegacyTheme`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( uselegacytheme ) )
                          ( n = `wrapping`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( wrapping ) )
                          ( n = `width`               v = width ) ) ).
  ...
  METHOD scroll_container.
    result = _generic( name   = `ScrollContainer`
                       t_prop = VALUE #( ( n = `height`      v = height )
                                         ...
                                         ( n = `id`          v = id )
                                         ( n = `visible`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `vertical`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( vertical ) )
                                         ( n = `horizontal`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( horizontal ) )
                                         ( n = `focusable`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( focusable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD search_field.
    ...
    _generic( name   = `SearchField`
              t_prop = VALUE #( ( n = `width`  v = width )
                                ...
                                ( n = `placeholder` v = placeholder )
                                ( n = `suggest` v = suggest )
                                ( n = `enableSuggestions` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablesuggestions ) )
                                ( n = `showRefreshButton` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showrefreshbutton ) )
                                ( n = `showSearchButton` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsearchbutton ) )
                                ( n = `visible` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `enabled` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `liveChange` v = livechange ) ) ).
  ENDMETHOD.
  ...
  METHOD select.
    result = _generic( name   = `Select`
                       t_prop = VALUE #(
                           ( n = `id`                  v = id )
                           ( n = `class`                  v = class )
                           ( n = `autoAdjustWidth`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( autoadjustwidth ) )
                           ( n = `columnRatio`         v = columnratio )
                           ( n = `editable`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( editable ) )
                           ( n = `enabled`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                           ( n = `forceSelection`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( forceselection ) )
                           ( n = `icon`                v = icon )
                           ( n = `maxWidth`            v = maxwidth )
                           ( n = `name`                v = name )
                           ( n = `required`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) )
                           ( n = `resetOnMissingKey`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( resetonmissingkey ) )
                           ( n = `selectedItemId`      v = selecteditemid )
                           ( n = `selectedKey`         v = selectedkey )
                           ( n = `showSecondaryValues` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsecondaryvalues ) )
                           ( n = `textAlign`           v = textalign )
                           ...
                           ( n = `valueStateText`      v = valuestatetext )
                           ( n = `width`               v = width )
                           ( n = `wrapItemsText`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( wrapitemstext ) )
                           ( n = `items`               v = items )
                           ( n = `selectedItem`        v = selecteditem )
                           ( n = `change`              v = change )
                           ( n = `liveChange`          v = livechange )
  ...
  METHOD shell.
    result = _generic(
        name   = `Shell`
        ns     = ns
        t_prop = VALUE #( ( n = `appWidthLimited`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( appwidthlimited ) ) ) ).
  ENDMETHOD.
  ...
  METHOD shell_bar.
    result = _generic( name   = `ShellBar`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `showCopilot`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcopilot ) )
                           ( n = `showMenuButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showmenubutton ) )
                           ( n = `showNavButton`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownavbutton ) )
                           ( n = `showNotifications`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownotifications ) )
                           ( n = `showProductSwitcher`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showproductswitcher ) )
                           ( n = `showSearch`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsearch ) )
  ...
  METHOD side_panel.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `sidePanelWidth`  v = sidepanelwidth )
                          ...
                          ( n = `sidePanelResizable`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( sidepanelresizable ) )
                          ( n = `actionBarExpanded`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( actionbarexpanded ) )
                          ( n = `toggle`    v = toggle )
                          ( n = `ariaLabel`  v = arialabel ) ) ).
  ENDMETHOD.
  ...
  METHOD simple_form.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `minWidth`   v = minwidth )
            ( n = `singleContainerFullSize`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( singlecontainerfullsize ) )
            ( n = `visible`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
            ( n = `width`       v = width )
            ( n = `id`       v = id )
  ...
  METHOD slider.
    ...
    _generic( name   = `Slider`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `enableTickmarks`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabletickmarks ) )
                                ( n = `enabled`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `value`   v = value )
                                ( n = `step`   v = step )
                                ( n = `change`   v = change )
  ...
  METHOD stacked_bar_micro_chart.
    ...
    _generic( name   = `StackedBarMicroChart`
              ...
              t_prop = VALUE #( ( n = `height`  v = height )
                                ...
                                ( n = `size`      v = size )
                                ( n = `hideOnNoData`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `displayZeroValue`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( displayzerovalue ) )
                                ( n = `showLabels`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( showlabels ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD standard_list_item.
    ...
    _generic(
        ...
        t_prop = VALUE #( ( n = `title`       v = title )
                          ...
                          ( n = `counter`     v = counter )
                          ( n = `activeIcon`     v = activeicon )
                          ( n = `adaptTitleSize`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( adapttitlesize ) )
                          ( n = `unread`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( unread ) )
                          ( n = `iconInset`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( iconinset ) )
                          ( n = `infoStateInverted`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( infostateinverted ) )
                          ( n = `wrapping`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( wrapping ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #( ( n = `id`  v = id )
                                   ...
                                   ( n = `useFocusColorAsContentColor`
                                     v = /vno/2ui5_cl_util=>boolean_abap_2_json( usefocuscolorascontentcolor ) )
                                   ( n = `visible`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD table.
    result = _generic( name   = `Table`
                       t_prop = VALUE #(
                           ...
                           ( n = `backgroundDesign`  v = backgrounddesign )
                           ( n = `visible`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                           ( n = `alternateRowColors`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( alternaterowcolors ) )
                           ( n = `fixedLayout`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( fixedlayout ) )
                           ( n = `showOverlay`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showoverlay ) )
                           ( n = `autoPopinMode`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( autopopinmode ) ) ) ).
  ENDMETHOD.
  ...
  METHOD table_select_dialog.
    ...
    result = _generic( name   = `TableSelectDialog`
                       t_prop = VALUE #(
                           ...
                           ( n = `growing`              v = /vno/2ui5_cl_util=>boolean_abap_2_json( growing ) )
                           ( n = `growingThreshold`     v = growingthreshold )
                           ( n = `multiSelect`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( multiselect ) )
                           ( n = `noDataText`           v = nodatatext )
                           ( n = `rememberSelections`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( rememberselections ) )
                           ( n = `resizable`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( resizable ) )
                           ( n = `searchPlaceholder`    v = searchplaceholder )
                           ( n = `showClearButton`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( showclearbutton ) )
                           ( n = `title`                v = title )
                           ( n = `titleAlignment`       v = titlealignment )
                           ( n = `items`                v = items )
                           ( n = `search`               v = search )
  ...
  METHOD tile_content.
    ...
    result = _generic( name   = `TileContent`
                       ...
                       t_prop = VALUE #( ( n = `unit`   v = unit )
                                         ...
                                         ( n = `state`   v = state )
                                         ( n = `disabled`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( disabled ) )
                                         ( n = `visible`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `footer` v = footer )
                                         ( n = `class` v = class ) ) ).
  ...
  METHOD timeline.
    ...
    result = _generic(
        ...
        ns     = 'commons'
        t_prop = VALUE #( ( n = 'id'                 v = id )
                          ( n = 'enableDoubleSided'  v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabledoublesided ) )
                          ( n = 'groupBy'            v = groupby )
                          ( n = 'growingThreshold'   v = growingthreshold )
                          ( n = 'filterTitle'        v = filtertitle )
                          ( n = 'sortOldestFirst'    v = /vno/2ui5_cl_util=>boolean_abap_2_json( sortoldestfirst ) )
                          ( n = 'enableModelFilter'  v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablemodelfilter ) )
                          ( n = 'enableScroll'       v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablescroll ) )
                          ( n = 'forceGrowing'       v = /vno/2ui5_cl_util=>boolean_abap_2_json( forcegrowing ) )
                          ( n = 'group'              v = /vno/2ui5_cl_util=>boolean_abap_2_json( group ) )
                          ( n = 'lazyLoading'        v = /vno/2ui5_cl_util=>boolean_abap_2_json( lazyloading ) )
                          ( n = 'showHeaderBar'      v = /vno/2ui5_cl_util=>boolean_abap_2_json( showheaderbar ) )
                          ( n = 'showIcons'          v = /vno/2ui5_cl_util=>boolean_abap_2_json( showicons ) )
                          ( n = 'showItemFilter'     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showitemfilter ) )
                          ( n = 'showSearch'         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsearch ) )
                          ( n = 'showSort'           v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsort ) )
                          ( n = 'showTimeFilter'     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showtimefilter ) )
                          ( n = 'sort'               v = /vno/2ui5_cl_util=>boolean_abap_2_json( sort ) )
  ...
  METHOD timeline_item.
    ...
    result = _generic(
        ...
        t_prop = VALUE #( ( n = 'id'                     v = id )
                          ( n = 'dateTime'               v = datetime )
                          ( n = 'title'                  v = title )
                          ( n = 'userNameClickable'      v = /vno/2ui5_cl_util=>boolean_abap_2_json( usernameclickable ) )
                          ( n = 'useIconTooltip'         v = /vno/2ui5_cl_util=>boolean_abap_2_json( useicontooltip ) )
  ...
  METHOD time_picker.
    ...
    _generic( name   = `TimePicker`
              t_prop = VALUE #(
                  ...
                  ( n = `textDirection`  v = textdirection )
                  ( n = `title`  v = title )
                  ( n = `showCurrentTimeButton` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcurrenttimebutton ) )
                  ( n = `showValueStateMessage` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                  ( n = `support2400` v = /vno/2ui5_cl_util=>boolean_abap_2_json( support2400 ) )
                  ( n = `initialFocusedDateValue` v = /vno/2ui5_cl_util=>boolean_abap_2_json( initialfocuseddatevalue ) )
                  ( n = `hideInput` v = /vno/2ui5_cl_util=>boolean_abap_2_json( hideinput ) )
                  ( n = `editable` v = /vno/2ui5_cl_util=>boolean_abap_2_json( editable ) )
                  ( n = `enabled` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                  ( n = `required` v = /vno/2ui5_cl_util=>boolean_abap_2_json( required ) )
  ...
  METHOD toggle_button.
    ...
    _generic( name   = `ToggleButton`
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `type`    v = type )
                                ( n = `class`   v = class )
                                ( n = `pressed` v = /vno/2ui5_cl_util=>boolean_abap_2_json( pressed ) ) ) ).
  ENDMETHOD.
  ...
  METHOD tree_table.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enableColumnReordering`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecolumnreordering ) )
                     ( n = `expandFirstLevel`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( expandfirstlevel ) )
                     ( n = `columnSelect`            v = columnselect )
                     ( n = `rowSelectionChange`      v = rowselectionchange )
                     ( n = `selectionBehavior`       v = selectionbehavior )
                     ( n = `id`                      v = id )
                     ( n = `alternateRowColors`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( alternaterowcolors ) )
                     ( n = `columnHeaderVisible`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( columnheadervisible ) )
                     ( n = `enableCellFilter`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecellfilter ) )
                     ( n = `enableColumnFreeze`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecolumnfreeze ) )
                     ( n = `enableCustomFilter`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecustomfilter ) )
                     ( n = `enableSelectAll`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableselectall ) )
                     ( n = `showNoData`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownodata ) )
                     ( n = `showOverlay`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( showoverlay ) )
                     ( n = `visible`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ...
                     ( n = `threshold`           v = threshold )
                     ( n = `width`           v = width )
                     ( n = `useGroupMode`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( usegroupmode ) )
  ...
  METHOD ui_column.
    result = _generic( name   = `Column`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `autoresizable`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( autoresizable ) )
  ...
  METHOD ui_table.
    ...
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `class`                     v = class )
            ( n = `enableCellFilter`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablecellfilter ) )
            ( n = `enableGrouping`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablegrouping ) )
            ( n = `enableSelectAll`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( enableselectall ) )
            ( n = `firstVisibleRow`           v = firstvisiblerow )
            ( n = `fixedBottomRowCount`       v = fixedbottomrowcount )
            ( n = `fixedColumnCount`          v = fixedcolumncount )
            ...
            ( n = `selectionMode`             v = selectionmode )
            ( n = `selectionBehavior`         v = selectionbehavior )
            ( n = `showColumnVisibilityMenu`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcolumnvisibilitymenu ) )
            ( n = `showNoData`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownodata ) )
            ( n = `threshold`                 v = threshold )
            ( n = `visibleRowCount`           v = visiblerowcount )
            ( n = `visibleRowCountMode`       v = visiblerowcountmode )
  ...
  METHOD upload_set.
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ( n = `id`                       v = id )
                     ( n = `instantUpload`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( instantupload ) )
                     ( n = `showIcons`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( showicons ) )
                     ( n = `uploadEnabled`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( uploadenabled ) )
                     ( n = `terminationEnabled`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( terminationenabled ) )
                     ( n = `uploadButtonInvisible`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( uploadbuttoninvisible ) )
                     ...
                     ( n = `directory`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( directory ) )
                     ( n = `multiple`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( multiple ) )
                     ...
                     ( n = `sameFilenameAllowed`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( samefilenameallowed ) )
  ...
  METHOD upload_set_item.
    result = _generic( name   = `UploadSetItem`
                       ...
                       t_prop = VALUE #( ( n = `fileName`      v = filename )
                                         ...
                                         ( n = `markers`       v = markers )
                                         ( n = `enabledEdit`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablededit ) )
                                         ( n = `enabledRemove` v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabledremove ) )
                                         ( n = `selected`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `visibleEdit`   v = /vno/2ui5_cl_util=>boolean_abap_2_json( visibleedit ) )
                                         ( n = `visibleRemove` v = /vno/2ui5_cl_util=>boolean_abap_2_json( visibleremove ) )
  ...
  METHOD variant_item.
    ...
    result = _generic(
                 ...
                 ns     = `vm`
                 t_prop = VALUE #(
                     ( n = `executeOnSelection`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( executeonselection ) )
                     ( n = `global`                  v = /vno/2ui5_cl_util=>boolean_abap_2_json( global ) )
                     ( n = `labelReadOnly`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( labelreadonly ) )
                     ...
                     ( n = `executeOnSelect`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( executeonselect ) )
                     ( n = `author`                  v = author )
                     ( n = `changeable`              v = /vno/2ui5_cl_util=>boolean_abap_2_json( changeable ) )
                     ( n = `enabled`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                     ( n = `favorite`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( favorite ) )
                     ( n = `key`                     v = key )
                     ( n = `text`                    v = text )
                     ( n = `title`                   v = title )
                     ( n = `textDirection`           v = textdirection )
                     ( n = `originalTitle`           v = originaltitle )
                     ( n = `originalExecuteOnSelect` v = /vno/2ui5_cl_util=>boolean_abap_2_json( originalexecuteonselect ) )
                     ( n = `remove`                  v = /vno/2ui5_cl_util=>boolean_abap_2_json( remove ) )
                     ( n = `rename`                  v = /vno/2ui5_cl_util=>boolean_abap_2_json( rename ) )
                     ( n = `originalFavorite`        v = /vno/2ui5_cl_util=>boolean_abap_2_json( originalfavorite ) )
                     ( n = `sharing`                 v = /vno/2ui5_cl_util=>boolean_abap_2_json( sharing ) )
                     ( n = `change`                  v = change ) ) ).
  ...
  METHOD variant_management.
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enabled`                v = /vno/2ui5_cl_util=>boolean_abap_2_json( enabled ) )
                     ( n = `inErrorState`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `initialSelectionKey`    v = initialselectionkey )
                     ( n = `lifecycleSupport`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( lifecyclesupport ) )
                     ( n = `selectionKey`           v = selectionkey )
                     ( n = `showCreateTile`         v = /vno/2ui5_cl_util=>boolean_abap_2_json( showcreatetile ) )
                     ( n = `showExecuteOnSelection` v = /vno/2ui5_cl_util=>boolean_abap_2_json( showexecuteonselection ) )
                     ( n = `showSetAsDefault`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsetasdefault ) )
                     ( n = `showShare`              v = /vno/2ui5_cl_util=>boolean_abap_2_json( showshare ) )
                     ( n = `standardItemAuthor`     v = standarditemauthor )
                     ( n = `standardItemText`       v = standarditemtext )
                     ( n = `useFavorites`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( usefavorites ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `executeOnSelectionForStandardDefault`
                       v = /vno/2ui5_cl_util=>boolean_abap_2_json( executeonselectionforstandflt ) )
                     ( n = `headerLevel`      v = headerlevel )
                     ( n = `inErrorState`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `maxWidth`      v = maxwidth )
                     ( n = `modelName`      v = modelname )
                     ( n = `resetOnContextChange`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( resetoncontextchange ) )
                     ( n = `showSetAsDefault`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsetasdefault ) )
                     ( n = `titleStyle`      v = titlestyle )
                     ( n = `updateVariantInURL`    v = /vno/2ui5_cl_util=>boolean_abap_2_json( updatevariantinurl ) )
                     ( n = `cancel`    v = cancel )
                     ( n = `initialized`    v = initialized )
                     ( n = `manage`    v = manage )
                     ( n = `save`    v = save )
  ...
  METHOD variant_management_sapm.
    result = _generic(
        ...
        t_prop = VALUE #(
            ...
            ( n = `select`    v = select )
            ( n = `items`    v = items )
            ( n = `creationAllowed`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( creationallowed ) )
            ( n = `inErrorState`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
            ( n = `modified`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( modified ) )
            ( n = `showFooter`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showfooter ) )
            ( n = `showSaveAs`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( showsaveas ) )
            ( n = `supportApplyAutomatically`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( supportapplyautomatically ) )
            ( n = `supportContexts`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( supportcontexts ) )
            ( n = `supportDefault`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( supportdefault ) )
            ( n = `supportFavorites`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( supportfavorites ) )
            ( n = `supportPublic`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( supportpublic ) )
            ( n = `visible`     v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
                        ) ).
  ...
  METHOD view_settings_dialog.
    ...
    result = _generic( name   = `ViewSettingsDialog`
                       t_prop = VALUE #(
                           ...
                           ( n = `groupDescending`          v = /vno/2ui5_cl_util=>boolean_abap_2_json( groupdescending ) )
                           ( n = `sortDescending`           v = /vno/2ui5_cl_util=>boolean_abap_2_json( sortdescending ) )
                           ( n = `title`                    v = title )
  ...
  METHOD wizard.
    result = _generic( name   = `Wizard`
                       t_prop = VALUE #(
                           ...
                           ( n = `busyIndicatorDelay`   v = busyindicatordelay )
                           ( n = `busyIndicatorSize`    v = busyindicatorsize )
                           ( n = `enableBranching`      v = /vno/2ui5_cl_util=>boolean_abap_2_json( enablebranching ) )
                           ( n = `fieldGroupIds`        v = fieldgroupids )
                           ( n = `finishButtonText`     v = finishbuttontext )
                           ( n = `height`               v = height )
                           ( n = `renderMode`           v = rendermode )
                           ( n = `showNextButton`       v = /vno/2ui5_cl_util=>boolean_abap_2_json( shownextbutton ) )
  ...
  METHOD wizard_step.
    ...
    result = _generic( name   = `WizardStep`
                       t_prop = VALUE #(
                           ...
                           (  n = `fieldGroupIds`        v = fieldgroupids )
                           (  n = `icon`                 v = icon )
                           (  n = `optional`             v = /vno/2ui5_cl_util=>boolean_abap_2_json( optional ) )
                           (  n = `title`                v = title )
                           (  n = `validated`            v = /vno/2ui5_cl_util=>boolean_abap_2_json( validated ) )
                           (  n = `visible`              v = /vno/2ui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD xml_get.
    ...
    IF me = mo_root.
      ...
      DATA lt_prop TYPE HASHED TABLE OF /vno/2ui5_if_types=>ty_s_name_value WITH UNIQUE KEY n.
      lt_prop = VALUE #(
          ( n = `z2ui5`             v = `z2ui5` )
...
*          ( n = `unified`           v = `sap.ui.unified` )
    ...
    LOOP AT mt_child INTO DATA(lr_child).
      result = result && CAST /vno/2ui5_cl_xml_view( lr_child )->xml_get( ).
    ENDLOOP.
  ...
  METHOD _generic.
    ...
    DATA(result2) = NEW /vno/2ui5_cl_xml_view( ).
  ...
  METHOD field.
    result = _generic(
        ...
        t_prop = VALUE #( ( n = `id`        v = id )
                          ...
                          ( n = `showEmptyIndicator`  v = /vno/2ui5_cl_util=>boolean_abap_2_json( showemptyindicator ) ) ) ).
  ENDMETHOD.
