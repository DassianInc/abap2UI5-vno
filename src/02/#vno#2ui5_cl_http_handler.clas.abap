CLASS /vno/2ui5_cl_http_handler DEFINITION
  PUBLIC
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    CLASS-METHODS run
      IMPORTING
        ...
        config TYPE /vno/2ui5_if_types=>ty_s_http_config OPTIONAL
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO /vno/2ui5_cl_http_handler.
    ...
    METHODS main
      IMPORTING
        s_config TYPE /vno/2ui5_if_types=>ty_s_http_config OPTIONAL.
    ...
    CLASS-METHODS get_response
      IMPORTING
        ...
        req    TYPE REF TO object OPTIONAL
        res    TYPE REF TO object OPTIONAL
        is_res TYPE /vno/2ui5_if_core_types=>ty_s_http_res.
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
    ...
    result = |<!DOCTYPE html>| && |\n| &&
             ...
             |      "z2ui5/controller/View1.controller.js": function()\{{ /vno/2ui5_cl_app_view1_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/Server.js": function()\{{ /vno/2ui5_cl_app_server_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/DebugTool.fragment.xml": '{ /vno/2ui5_cl_app_debugtool_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/cc/DebugTool.js": function()\{{ /vno/2ui5_cl_app_debugtool_js=>get( ) }\},| && |\n| &&
             |    \});| && |\n| &&
  ...
  METHOD _http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW /vno/2ui5_cl_core_handler( is_req-body ).
    ELSE.
    ...
    TRY.
        IF lo_post IS BOUND.
          DATA(li_app) = CAST /vno/2ui5_if_app( lo_post->mo_action->mo_app->mo_app ).
