INTERFACE /vno/2ui5_if_ajson
  ...
  DATA mt_json_tree TYPE /vno/2ui5_if_ajson_types=>ty_nodes_ts READ-ONLY.

  " CLONING

  METHODS clone
    RETURNING
      VALUE(ri_json) TYPE REF TO /vno/2ui5_if_ajson
    RAISING
      /vno/2ui5_cx_ajson_error.
  METHODS filter
    IMPORTING
      ii_filter TYPE REF TO /vno/2ui5_if_ajson_filter
    RETURNING
      VALUE(ri_json) TYPE REF TO /vno/2ui5_if_ajson
    RAISING
      /vno/2ui5_cx_ajson_error.
  METHODS map
    IMPORTING
      ii_mapper TYPE REF TO /vno/2ui5_if_ajson_mapping
    RETURNING
      VALUE(ri_json) TYPE REF TO /vno/2ui5_if_ajson
    RAISING
      /vno/2ui5_cx_ajson_error.
  ...
  METHODS get_node_type
    IMPORTING
      iv_path TYPE string
    RETURNING
      VALUE(rv_node_type) TYPE /vno/2ui5_if_ajson_types=>ty_node_type.
  ...
  METHODS set
    IMPORTING
      ...
      iv_node_type TYPE /vno/2ui5_if_ajson_types=>ty_node_type OPTIONAL
    RETURNING
      VALUE(ri_json) TYPE REF TO /vno/2ui5_if_ajson
    RAISING
      /vno/2ui5_cx_ajson_error.
