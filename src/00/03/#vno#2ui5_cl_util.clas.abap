CLASS /vno/2ui5_cl_util DEFINITION
  PUBLIC
  INHERITING FROM /vno/2ui5_cl_util_abap
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE /vno/2ui5_cl_util_abap=>ty_t_fix_val ##NEEDED.
    ...
    CLASS-METHODS filter_get_sql_where
      IMPORTING
        val           TYPE  /vno/2ui5_cl_util=>ty_t_filter_multi
      RETURNING
        VALUE(result) TYPE string.
    ...
    CLASS-METHODS itab_get_by_struc
      IMPORTING
        val           TYPE any
      RETURNING
        VALUE(result) TYPE /vno/2ui5_cl_util=>ty_t_name_value.
...
CLASS /vno/2ui5_cl_util IMPLEMENTATION.
...
*    GET REFERENCE OF val INTO result.
  ...
  METHOD filter_update_tokens.
    ...
    DATA(lt_range) = /vno/2ui5_cl_util=>filter_get_range_t_by_token_t( result[ name = name ]-t_token ).
  ...
  METHOD json_parse.
    TRY.
        ...
        /vno/2ui5_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA(li_ajson) = CAST /vno/2ui5_if_ajson( /vno/2ui5_cl_ajson=>create_empty( ) ).
...
*                      v = c_trim_lower( lv_value ) ) INTO TABLE rt_params.
  ...
  METHOD xml_srtti_stringify.
    ...
    ELSE.
      ...
      TRY.
          CALL METHOD /vno/2ui5_cl_srt_typedescr=>('CREATE_BY_DATA_OBJECT')
            EXPORTING
              data_object = data
            RECEIVING
              srtti       = srtti.
  ...
  METHOD itab_get_by_struc.
    ...
    DATA(lt_attri) = /vno/2ui5_cl_util=>rtti_get_t_attri_by_any( val ).
*    result  = VALUE z2ui5_cl_util=>ty_t_name_value( ).
    LOOP AT lt_attri REFERENCE INTO DATA(lr_attri).
      ...
      CASE /vno/2ui5_cl_util=>rtti_get_type_kind( <component> ).
...
*         e_t_where      = lt_where
  ...
  METHOD msg_get_t.
    ...
    result = /vno/2ui5_cl_util_msg=>msg_get( val ).
  ...
  METHOD rtti_get_data_element_text_l.
    ...
    result = /vno/2ui5_cl_util=>rtti_get_data_element_texts( val )-long.
  ...
  METHOD msg_get_by_msg.
    ...
    DATA(ls_msg) = VALUE /vno/2ui5_cl_util=>ty_s_msg(
      id         = id
      no         = no
      v1         = v1
      v2         = v2
