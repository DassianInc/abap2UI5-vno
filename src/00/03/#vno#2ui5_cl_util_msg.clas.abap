CLASS /vno/2ui5_cl_util_msg DEFINITION PUBLIC
  FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    ...
    CLASS-METHODS msg_map
      IMPORTING
        name          TYPE clike
        val           TYPE data
        is_msg        TYPE /vno/2ui5_cl_util=>ty_s_msg
      RETURNING
        VALUE(result) TYPE /vno/2ui5_cl_util=>ty_s_msg.
...
CLASS /vno/2ui5_cl_util_msg IMPLEMENTATION.

  METHOD msg_get.

    DATA(lv_kind) = /vno/2ui5_cl_util=>rtti_get_type_kind( val ).
    CASE lv_kind.
      ...
      WHEN cl_abap_datadescr=>typekind_struct1 OR cl_abap_datadescr=>typekind_struct2.
        ...
        DATA(ls_result) = VALUE /vno/2ui5_cl_util=>ty_s_msg( ).
...
*          ASSIGN (lv_name) TO FIELD-SYMBOL(<comp>).
      ...
      WHEN cl_abap_datadescr=>typekind_oref.
        TRY.
            ...
            DATA(lt_attri_o) = /vno/2ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
              ...
              CATCH cx_root.
                ...
                TRY.
                  ...
                  CATCH cx_root INTO DATA(lx2).
                    ...
                    lt_attri_o = /vno/2ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
