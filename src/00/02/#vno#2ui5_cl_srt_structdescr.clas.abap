...
CLASS /vno/2ui5_cl_srt_structdescr DEFINITION
  PUBLIC
  INHERITING FROM /vno/2ui5_cl_srt_complexdescr
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF sabap_componentdescr,
        name       TYPE string,
        type       TYPE REF TO /vno/2ui5_cl_srt_datadescr,
...
CLASS /vno/2ui5_cl_srt_structdescr IMPLEMENTATION.
  METHOD constructor.
    DATA components_rtti TYPE abap_component_tab.
    DATA scomponent      TYPE sabap_componentdescr.
    DATA scomponent_rtti TYPE REF TO /vno/2ui5_cl_srt_datadescr.
    ...
    LOOP AT components_rtti ASSIGNING <component>.
      ...
      scomponent_rtti ?= /vno/2ui5_cl_srt_datadescr=>create_by_rtti( <component>-type ).
